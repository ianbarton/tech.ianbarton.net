...
#+PROPERTY: TAGS raspberrypi
#+PROPERTY: SUMMARY Using a raspberry pi to create a WiFi based dlna multimedia server, which can be used in a car, or as a standalone box.
#+SETUPFILE: "../setup.org"
